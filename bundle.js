...
function cpdLexer(input) {
	antlr4.Lexer.call(this, input);
    this._interp = new antlr4.atn.LexerATNSimulator(this, atn, decisionsToDFA, new antlr4.PredictionContextCache());
    return this;
}

cpdLexer.prototype = Object.create(antlr4.Lexer.prototype);
cpdLexer.prototype.constructor = cpdLexer;

Object.defineProperty(cpdLexer.prototype, "atn", {
        get : function() {
                return atn;
        }
});

cpdLexer.EOF = antlr4.Token.EOF;
cpdLexer.END = 1;
cpdLexer.IF = 2;
cpdLexer.THEN = 3;
cpdLexer.ELSE = 4;
...
cpdLexer.prototype.channelNames = [ "DEFAULT_TOKEN_CHANNEL", "HIDDEN" ];

cpdLexer.prototype.modeNames = [ "DEFAULT_MODE" ];

cpdLexer.prototype.literalNames = [ null, null, null, null, null, null, 
                                    null, null, null, "','", "'('", "')'", 
                                    "':'", "'='", null, "'+'", "'/'", "'*'", 
                                    "'%'", null, null, null, null, null, 
                                    null, null, null, null, "'TO'" ];

cpdLexer.prototype.symbolicNames = [ null, "END", "IF", "THEN", "ELSE", 
                                     "ENDIF", "ELSEIF", "DO", "ENDDO", "COMMA", 
                                     "LPAR", "RPAR", "COLON", "ASSIGN", 
                                     "MINUS", "PLUS", "DIV", "STAR", "MOD", 
                                     "NOT", "AND", "OR", "LT", "LE", "GT", 
                                     "GE", "NE", "EQ", "TO", "VARNAME", 
                                     "INT", "EOL", "WS" ];

cpdLexer.prototype.ruleNames = [ "END", "IF", "THEN", "ELSE", "ENDIF", "ELSEIF", 
                                 "DO", "ENDDO", "COMMA", "LPAR", "RPAR", 
                                 "COLON", "ASSIGN", "MINUS", "PLUS", "DIV", 
                                 "STAR", "MOD", "NOT", "AND", "OR", "LT", 
                                 "LE", "GT", "GE", "NE", "EQ", "TO", "ALNUM", 
                                 "ALPHA", "NUM0", "NUM", "VARNAME", "INT", 
                                 "EOL", "WS" ];

cpdLexer.prototype.grammarFileName = "cpd.g4";



exports.cpdLexer = cpdLexer;
...
},{"./cpdListener":2,"./cpdVisitor":4,"antlr4/index":47}],4:[function(require,module,exports){
// Generated from cpd.g4 by ANTLR 4.7.2
// jshint ignore: start
var antlr4 = require('antlr4/index');
...
},{"./cpdLexer":1,"./cpdParser":3,"./cpdVisitor":4,"antlr4/index":47}],6:[function(require,module,exports){
//
